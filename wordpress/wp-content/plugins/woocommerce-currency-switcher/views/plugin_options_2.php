    ...
    <div class="section">
        ...
        <div class="woocs__section-title woocs-mb-4">
            ...
            <?php if ($WOOCS->notes_for_free): ?>
                <?php if (time() > 1687125600 && time() < 1688076000): ?>
                    <div>
                        <br><a href="https://pluginus.net/affiliate/woocommerce-currency-switcher" style="padding: 9px 12px" target="_blank" class="woocs__button"><span class="icon-upload"></span><?php esc_html_e("Upgrade to Premium with 33% OFF until 30th June 2023", 'woocommerce-currency-switcher') ?></a>
                    </div>
                <?php endif; ?>
            <?php endif; ?>
